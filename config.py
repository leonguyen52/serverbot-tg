...
serverbotpath = '/root/serverbot' # User folder with this bot.
serverbotpathdb = '/root/serverbot/db' # User folder with bot database. 
...
pingcalarm = 200 # When ping will be more than X ms, you will get alarm.
