...
serverbotpath = '/root/serverbot-tg' # User folder with this bot.
serverbotpathdb = '/root/serverbot-tg/db' # User folder with bot database. 
...
pingcalarm = 350 # When ping will be more than X ms, you will get alarm.
